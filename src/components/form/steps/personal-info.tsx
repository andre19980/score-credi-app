    ...
    >
      ...
      <div className="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6 mt-4">
        ...
        <div className="sm:col-span-2">
          ...
          <div className="mt-2">
            <div className="flex w-full bg-white rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
              <input
                type="number"
